<footer>
        <section class="foot_logo">
            <a href="/ass5/index.php"><img src="/ass4/assets/Logo.jpg" alt="Logo" width="240px" height="70px" ></a> 
        </section>
        <section class="footmenu">
            <ul class="ul2"> 
              ...
              <a href="/ass5" style="text-decoration: none;"><li>PHP_Calculator</li></a>
              <a href="/ass6" style="text-decoration: none;"><li>SALARY GENERATOR</li></a>
              </ul>
         </section>
